...
const Login = () => {
    return (
        <div className="flex flex-col mx-auto my-5 max-w-md p-6 rounded-md sm:p-10 bg-gray-900">
            ...
            <form className="space-y-12">
                ...
                <div className="space-y-2">
                    <div>
                        <button type="button" className="w-full px-8 py-3 font-semibold rounded-md bg-primary">Sign in</button>
                    </div>
